...
-include vendor/Doro/ckt72_w_kk/BoardConfigVendor.mk

LOCAL_PATH := device/Doro/ckt72_w_kk

TARGET_BOARD_PLATFORM := mt6572               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := ckt72_w_kk    # From ro.product.board
...
BOARD_KERNEL_CMDLINE := console=ttyMT0,921600n1 vmalloc=496M slub_max_order=0 lcm=1-ili9806e_dsi_cmd_6572 fps=6640 vram=11534336 bootprof.pl_t=827 bootprof.lk_t=1861 printk.disable_uart=1 boot_reason=0 androidboot.selinux=permissive
BOARD_KERNEL_BASE := 0x10000000
BOARD_KERNEL_PAGESIZE := 2048
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x01000000 --kernel_offset 0x00008000 --tags_offset 0x00000100
# Set FSTAB
